...
describe('Product Search E2E Tests', () => {
    ...
    beforeAll(async () => {
        ...
        const product1Res = await request(app.getHttpServer())
            ...
            .send({
                ...
                description: 'High performance gaming laptop with RGB keyboard and powerful graphics card',
                price: 1299.99,
                stockQuantity: 10,
                categoryId,
                sku: 'LAPTOP-001',
    ...
    describe('GET /api/v1/products/search', () => {
        it('should search products by name', async () => {
            ...
            const gamingProducts = res.body.data.filter((p: any) =>
        ...
        it('should require query parameter', async () => {
            ...
            expect(res.body.message.some((msg: string) => msg.includes('query'))).toBe(true);
        });
